...
public class CustomAdapterColors extends ArrayAdapter<Word> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView mivok_word = listItemView.findViewById(R.id.textview2);
        mivok_word.setText(current_position.get_miwok_translation());

        ImageView img = listItemView.findViewById(R.id.imageview1);
        img.setImageResource(current_position.getImg());
        ...
        img2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp3 = MediaPlayer.create(getContext(), current_position.get_mp3());
                mp3.start();
